# QBI File Format Version 1 (QBI1)

QBI file-format version 1 is identified by the magic `QBI1`. It is the stable
default format written by `qbix`. See [QBI File Formats](qbi-format.md) for the
version overview.
